...
A number of changes to the way Tubaclecoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mTLC per kB (0.00001 TLC). This is to prepare for dropping the minimum transaction fee to 0.1 mTLC per kB (0.0001 TLC) in the next release.
