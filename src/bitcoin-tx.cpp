...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tubaclecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tubaclecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tubaclecoin transaction") + "\n" +
              "  tubaclecoin-tx [options] -create [commands]   " + _("Create hex-encoded tubaclecoin transaction") + "\n" +
              "\n";
