...
#if defined(NDEBUG)
# error "Tubaclecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Tubaclecoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s TLC additional fees, %d delta bytes\n",
