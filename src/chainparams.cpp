...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.tubaclecoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.tubaclecointools.com", true);
        vSeeds.emplace_back("dnsseed.tubaclecoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 242425, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("testnet-seed.tubaclecointools.com", true);
        vSeeds.emplace_back("seed-b.tubaclecoin.loshan.co.uk", true);
